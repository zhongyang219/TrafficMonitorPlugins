...
BOOL CManagerDialog::OnInitDialog()
{
    ...
    CheckDlgButton(IDC_POS1_CHECK, m_data.m_show_positions[0]);
    CheckDlgButton(IDC_POS2_CHECK, m_data.m_show_positions[1]);
    CheckDlgButton(IDC_POS3_CHECK, m_data.m_show_positions[2]);
    CheckDlgButton(IDC_POS4_CHECK, m_data.m_show_positions[3]);
...
void CManagerDialog::OnBnClickedOk()
{
    ...
    m_data.m_show_positions[0] = (IsDlgButtonChecked(IDC_POS1_CHECK) != 0);
    m_data.m_show_positions[1] = (IsDlgButtonChecked(IDC_POS2_CHECK) != 0);
    m_data.m_show_positions[2] = (IsDlgButtonChecked(IDC_POS3_CHECK) != 0);
    m_data.m_show_positions[3] = (IsDlgButtonChecked(IDC_POS4_CHECK) != 0);
